...
def mainProgram(): 
    while True:
        try: 
            ...
            choice = input("1. Add to a list, 2. Return the value at an index position! 3: Random Int 4: Add a bunch, 5: Print list, 6: Linear Search, 7: Sort List, 8: Print Lists 9: Recursive Binary Search, 10: Iterative Binary Search, 11: Quit    ")
            if choice == "1": 
                addToList()
            elif choice == "2": 
                indexValues()
